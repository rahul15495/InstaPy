...
def get_user_info(browser):
    ...
    try:
        ...
        followingList= extract_followers(browser, infos[2])
...
def extract_followers(browser, link):
    link.click()
    list_items= browser.find_elements_by_class_name("wo9IH")
    return list_items
